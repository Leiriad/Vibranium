...
public class VibraniumEntitiesFabric extends VibraniumEntities {
	public static void init(){
        ...
        VIBRANIUM_BLOCK_ENTITY = (RegistrySupplier<BlockEntityType<VibraniumBlockEntity>>) register("vibranium_block", ()-> FabricBlockEntityTypeBuilder.create(VibraniumBlockEntity::new, VibraniumBlocks.VIBRANIUM_BLOCK.get()).build());
