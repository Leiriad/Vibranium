...
public class ReactorOutletItem extends BlockItem {
    public static Item.Properties getProperties() {
        return new Item.Properties();
    }
    public ReactorOutletItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext tooltipContext, TooltipDisplay tooltipDisplay, Consumer<Component> consumer, TooltipFlag tooltipFlag) {
        consumer.accept(Component.translatable("tooltip." + VibraniumMod.MOD_ID + ".reactor_outlet.function")
