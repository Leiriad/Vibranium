...
public class BlackGravelItem extends BlockItem {
    public static Properties getProperties() {
        return new Properties();
    }
    public BlackGravelItem(Block block, Properties properties) {super(block, properties);}
    ...
    public void appendHoverText(ItemStack stack, TooltipContext tooltipContext, TooltipDisplay tooltipDisplay, Consumer<Component> consumer, TooltipFlag tooltipFlag) {
        ...
        consumer.accept(Component.translatable("tooltip." + VibraniumMod.MOD_ID + ".black_gravel.info")
