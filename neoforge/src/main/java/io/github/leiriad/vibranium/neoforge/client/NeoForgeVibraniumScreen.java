...
public class NeoForgeVibraniumScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        clientCategory.addEntry(entryBuilder.startSelector(
                ...
                .setNameProvider(value -> Component.translatable("text.vibranium.config.hud_alignment." + value.toLowerCase()))
        ...
        overworldCategory.addEntry(entryBuilder.startIntField(
                ...
                .setTooltip(Component.translatable("text.vibranium.config.tooltip.spacing.line1","text.vibranium.config.tooltip.spacing.line2"))
                .build());
        ...
        overworldCategory.addEntry(entryBuilder.startIntField(
                ...
                .setTooltip(Component.translatable("text.vibranium.config.tooltip.separation.line1","text.vibranium.config.tooltip.separation.line2"))
                .build());
